...
def totalerrors_polar2(method, dt_values, P, tf):
    errors = []
...
def totalerrors_cartesian2(method, dt_values, P, tf):
    errors = []
...
def main():
    ...
    if 'polar' in args.method1:
        errors1 = totalerrors_polar2(args.method1, dt_values, P, args.tf)
    else:
        errors1 = totalerrors_cartesian2(args.method1,dt_values, P, args.tf )
    plt.loglog(dt_values, errors1, marker='o', linestyle='--',color='blue', label=f'{args.method1}')
    errors2 = None
    if args.method2:
        if 'polar' in args.method2:
            errors2 = totalerrors_polar2(args.method2, dt_values, P, args.tf)
        else:
